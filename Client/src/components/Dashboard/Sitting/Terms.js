...
function Terms() {
  return (
    <div className="term-container">
      ...
      <h4 className="term-info">1. ACCEPTANCE THE USE OF LOREM IPSUM TERMS AND CONDITIONS</h4>
      <p className="term-info">
        Your access to and use of Lorem Ipsum (the app) is subject exclusively
        to these Terms and Conditions. You will not use the app for any purpose
        ...
        Conditions you must immediately stop using the app.
      </p>

      <h4 className="term-info">2. CREDIT CARD DETAILS</h4>
      <p className="term-info">
      ...
      <h4 className="term-info">3. LEGAL ADVICE</h4>
      <p className="term-info">
      ...
      <h4 className="term-info">4. CHANGE OF USE</h4>
      <p className="term-info">Lorem Ipsum reserves the right to:</p>
      <p className="term-info">
      ...
      <h4 className="term-info">5. LINKS TO THIRD PARTY APPS AND WEBSITES</h4>
      <p className="term-info">
        Lorem Ipsum app may include links to third party apps and websites that
      ...
      <h4 className="term-info">6. COPYRIGHT</h4>
      <p className="term-info">
        6.1 All copyright, trade marks and all other intellectual property
        rights in the app and its content (including without limitation the app
        design, text, graphics and all software and source codes connected with
        the app) are owned by or licensed to Lorem Ipsum or otherwise used by
        Lorem Ipsum as permitted by law.
      </p>
      <p className="term-info">
      ...
      <h4 className="term-info">7. LINKS TO AND FROM OTHER APPS AND WEBSITES</h4>
      <p className="term-info">
      ...
      <p className="term-info">
        7.2 Any party wishing to link to this app is entitled to do so provided
        that the conditions below are observed:
      </p>
      <p className="term-info">
      ...
      <p className="term-info">(b) You do not misrepresent your relationship with this app; and</p>
      <p className="term-info">
        (c) The app from which you link to this app does not contain offensive
      ...
      <p className="term-info">
        7.3 By linking to this app in breach of our terms, you shall indemnify
        us for any loss or damage suffered to this app as a result of such
        linking.
      </p>

      <h4 className="term-info">8. DISCLAIMERS AND LIMITATION OF LIABILITY</h4>
      <p className="term-info">
        8.1 The app is provided on an AS IS and AS AVAILABLE basis without any
      ...
      <p className="term-info">
        8.2 To the extent permitted by law, Lorem Ipsum will not be liable for
        ...
        or in connection with the use of the app.
      </p>
      <p className="term-info">
        8.3 Lorem Ipsum makes no warranty that the functionality of the app will
      ...
      <p className="term-info">
        8.4 Nothing in these Terms and Conditions shall be construed so as to
      ...
      <h4 className="term-info">9. INDEMNITY</h4>
      <p className="term-info">
        ...
        Conditions or other liabilities arising out of your use of this app.
      </p>

      <h4 className="term-info">10. SEVERANCE</h4>
      <p className="term-info">
      ...
      <h4 className="term-info">11. WAIVER</h4>
      <p className="term-info">
      ...
      <h4 className="term-info">12. GOVERNING LAW</h4>
      <p className="term-info">
